...
#define STRING_CONFIG_H_AUTHOR "(Scholli,V1.00)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "VORON 1.X"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 608 }
